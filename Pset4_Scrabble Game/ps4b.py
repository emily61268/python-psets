...
#compPlayHand({'x': 2, 'z': 2, 'q': 2, 'n': 2, 't': 2}, wordList, 12)
    ...
    while True:
        ...
        if user_command == 'r':
            try:
                hand = hand
                while True:
                    user_command2 = input("Enter u to have yourself play, c to have the computer play: ")
                    if user_command2 == 'u':
                        start_time = time.time()
                        playHand(hand, wordList, HAND_SIZE)
                        e = time.time() - start_time
                        print("You spent ", end="")
                        print("%02d hour(s) %02d min(s) %.02f sec(s)" % (e // 3600, (e % 3600 // 60), (e % 60)), end="")
                        print(" to finish the game!")
                        break
                    elif user_command2 == 'c':
                        start_time = time.time()
                        compPlayHand(hand, wordList, HAND_SIZE)
                        e = time.time() - start_time
                        print("The computer spent ", end="")
                        print("%02d hour(s) %02d min(s) %.02f sec(s)" % (e // 3600, (e % 3600 // 60), (e % 60)), end="")
                        print(" to finish the game!")
                        break
                    else:
